...
namespace Rufus31415.MixedReality.Toolkit.WebXR.Input
{
    ...
    [MixedRealityController(SupportedControllerType.ArticulatedHand, new[] { Microsoft.MixedReality.Toolkit.Utilities.Handedness.Left, Microsoft.MixedReality.Toolkit.Utilities.Handedness.Right })]
    public class SimpleWebXRHand : BaseHand
    {
        public SimpleWebXRHand(TrackingState trackingState, Microsoft.MixedReality.Toolkit.Utilities.Handedness controllerHandedness, IMixedRealityInputSource inputSource = null, MixedRealityInteractionMapping[] interactions = null)
        ...
        protected readonly Dictionary<Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint, MixedRealityPose> jointPoses = new Dictionary<Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint, MixedRealityPose>();
        /// <inheritdoc/>
        public override bool TryGetJoint(Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint joint, out MixedRealityPose pose)
        {
        ...
        public void UpdateController(WebXRInputSource controller)
        {
            ...
            jointPoses[Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint.Wrist] = GetJointMixedRealityPose(controller.Hand.Joints[WebXRHand.WRIST]);
            ...
            for (int i = WebXRHand.THUMB_METACARPAL; i < WebXRHand.JOINT_COUNT; i++)
            {
                ...
                jointPoses[(Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint)(i + 2)] = GetJointMixedRealityPose(joint);
            }

            jointPoses[Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint.Palm] = 
                new MixedRealityPose((jointPoses[Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint.MiddleMetacarpal].Position + jointPoses[Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint.MiddleMetacarpal].Position)/2, 
                    jointPoses[Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint.MiddleMetacarpal].Rotation) ;

            var indexPose = jointPoses[Microsoft.MixedReality.Toolkit.Utilities.TrackedHandJoint.IndexTip];
