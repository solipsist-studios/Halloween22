...
namespace Rufus31415.MixedReality.Toolkit.WebXR.Input
{
    ...
    public class SimpleWebXRController : BaseController
    {
        ...
        public SimpleWebXRController(TrackingState trackingState, Microsoft.MixedReality.Toolkit.Utilities.Handedness controllerHandedness, IMixedRealityInputSource inputSource = null, MixedRealityInteractionMapping[] interactions = null)
        ...
        [System.Obsolete]
        public override void SetupDefaultInteractions(Microsoft.MixedReality.Toolkit.Utilities.Handedness controllerHandedness)
        {
