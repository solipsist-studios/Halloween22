...
namespace Rufus31415.MixedReality.Toolkit.WebXR.Input
{
    ...
    {
        private readonly Dictionary<Microsoft.MixedReality.Toolkit.Utilities.Handedness, SimpleWebXRHand> trackedHands = new Dictionary<Microsoft.MixedReality.Toolkit.Utilities.Handedness, SimpleWebXRHand>();
        private readonly Dictionary<Microsoft.MixedReality.Toolkit.Utilities.Handedness, SimpleWebXRController> trackedControllers = new Dictionary<Microsoft.MixedReality.Toolkit.Utilities.Handedness, SimpleWebXRController>();

        private readonly Dictionary<Microsoft.MixedReality.Toolkit.Utilities.Handedness, SimpleWebXRController> inactiveControllerCache = new Dictionary<Microsoft.MixedReality.Toolkit.Utilities.Handedness, SimpleWebXRController>();
        ...
        public override void Update()
        {
            ...
            UpdateController(SimpleWebXR.LeftInput, Microsoft.MixedReality.Toolkit.Utilities.Handedness.Left);
            UpdateController(SimpleWebXR.RightInput, Microsoft.MixedReality.Toolkit.Utilities.Handedness.Right);
        }

        #region Controller Management

        protected void UpdateController(WebXRInputSource controller, Microsoft.MixedReality.Toolkit.Utilities.Handedness handedness)
        {
        ...
        private SimpleWebXRController GetOrAddController(Microsoft.MixedReality.Toolkit.Utilities.Handedness handedness)
        {
        ...
        private void RemoveControllerDevice(Microsoft.MixedReality.Toolkit.Utilities.Handedness handedness)
        {
        ...
        private SimpleWebXRHand GetOrAddHand(Microsoft.MixedReality.Toolkit.Utilities.Handedness handedness)
        {
        ...
        private void RemoveHandDevice(Microsoft.MixedReality.Toolkit.Utilities.Handedness handedness)
        {
